    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="p-6 bg-green-50 border-none">
          <p className="text-xs font-bold text-green-600 uppercase">Present Today</p>
          <h3 className="text-3xl font-bold mt-1 text-green-700">{attendance.length} / {cleaners.length}</h3>
        </Card>
        <Card className="p-6">
